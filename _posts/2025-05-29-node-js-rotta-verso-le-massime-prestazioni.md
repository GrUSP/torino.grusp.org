...
[![](https://torino.grusp.org/wp-content/uploads/2025/05/incontro_nodejs_28_maggio_2-1024x768.jpeg)](<https://torino.grusp.org/wp-content/uploads/2025/05/incontro_nodejs_28_maggio_2.jpeg>)

In questo meetup, [Gabriele Fontana](<https://www.linkedin.com/in/gabrielefontana>), Senior Full Stack Engineer presso [Beefree](<https://beefree.io/>) ci ha presentato le strategie chiave per massimizzare le prestazioni nelle applicazioni in **Node.js**. Partendo da una comprensione dell'architettura di Node.js, Gabriele ha analizzato i comuni colli di bottiglia che possono degradare le performance, come il blocco dell'Event Loop.

  
Attraverso esempi pratici e dimostrazioni live, utilizzando il framework [Fastify](<https://fastify.dev/>) come caso studio, sono state illustrate tecniche concrete per ottimizzare le applicazioni in Node.js.  
...
Le slide dell'incontro sono disponibili [qui](<https://torino.grusp.org/wp-content/uploads/2025/05/Nodejs_-rotta-verso-le-massime-prestazioni.pdf>). Gabriele ha anche realizzato un repository su github <https://github.com/gafreax/talk-node-performance-example> dove potrete trovare gli esempi presentati durante l'incontro.
