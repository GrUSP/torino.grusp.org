...
- **Mailing list:** [iscriviti alla mailing list]({{ '/mailing-list/' | relative_url }}) del gruppo
- **Meetup:** [#PUGTO su Meetup]({{ site.social.meetup }}), dove annunciamo tutti gli incontri

Il dominio, la mailing list e l'hosting storico sono offerti da
[GrUSP]({{ site.social.grusp }}) — per informazioni sulle conferenze
nazionali: [info@grusp.org](mailto:info@grusp.org).
